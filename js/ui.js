...
function toggleLoading(isLoading) {
  ...
  var magGlassIcon = document.getElementById("search-icon");
  var hourglassIcon = document.getElementById("load-icon");
  var button = document.getElementById("search-button");
  if (isLoading) {
    console.log("Is loading...");
    magGlassIcon.style.display = "none";
    hourglassIcon.style.display = "inline";
    button.lastElementChild.innerHTML = "Loading...";
    button.disabled = true;
  } else {
    console.log("Loading done!");
    magGlassIcon.style.display = "inline";
    hourglassIcon.style.display = "none";
    button.lastElementChild.innerHTML = "Search";
